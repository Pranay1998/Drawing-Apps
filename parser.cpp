...
case 1 : numberOfCommands++;
numberOfALU++;
break;	
case 2 : numberOfCommands++;
numberOfALU++;
break;
case 3 : numberOfCommands++;
numberOfALU++;
break;
case 4 :  numberOfCommands++;
numberOfALU++;
break;
case 5 :  numberOfCommands++;
numberOfALU++;
break;
case 6 : numberOfCommands++;
numberOfALU++;
break;
case 7 :  numberOfCommands++;
numberOfALU++;
break;
case 8 : numberOfCommands++;
numberOfALU++;
break;
case 9 : numberOfCommands++;
numberOfCompare_Jump++;
break;
case 10: numberOfCommands++;
numberOfCompare_Jump++;
break;
case 11:  numberOfCommands++;
numberOfCompare_Jump++;
break;
case 12:  numberOfCommands++;
numberOfCompare_Jump++;
break;
case 13: numberOfCommands++;
numberOfCompare_Jump++;
break;
case 14: numberOfCommands++;
numberOfCompare_Jump++;
break;
case 15: numberOfCommands++;
numberOfCompare_Jump++;
break;
case 16: numberOfCommands++;
numberOfLd_Sd++;
break;	
case 17:  numberOfCommands++;
numberOfLd_Sd++;
break;	
case 18:   numberOfCommands++;
numberOfLd_Sd++;
break;
case 19:  numberOfCommands++;
numberOfLd_Sd++;
break;
default : cerr << "Error in line " << line_count<<": Invalid Operand, Opcode Combination" << endl;
	...
	for (int j = 0; j< 40 ; j++) {
	cerr <<"Error on Line 3 missing operands" << endl;
	cerr <<"Error on Line" << j <<" missing "<<endl;
	cerr<<"Error on line "<< j <<":invalid or opcode missing or operand extra or directive duplicate"<<endl;
	system("cls");
}
